...
def get_args():
    ...
    parser.add_argument('--train_task', default='', choices=['sen', 'trans', 'qa','mmlu','glue_mrpc','glue_qqp','labeled_final','anli','mnli','qnli','boolq','copa','arc_easy','hella','winog', 'cosmos', 'agnews', 'commonsense_qa'], type=str, nargs='+', help='Training tasks')
    parser.add_argument('--test_task', default='', choices=['sen', 'trans', 'qa','mmlu','glue_mrpc','glue_qqp','labeled_final','anli','mnli','qnli','boolq','copa','arc_easy','hella','winog', 'cosmos', 'agnews', 'commonsense_qa'], nargs='+', type=str, help='Evaluation Data')
