...
def get_args():
    ...
    parser.add_argument('--train_task', default='', choices=['sen', 'trans', 'qa','mmlu'], type=str, nargs='+', help='Training tasks')
    parser.add_argument('--test_task', default='', choices=['sen', 'trans', 'qa','mmlu'], nargs='+', type=str, help='Evaluation Data')
