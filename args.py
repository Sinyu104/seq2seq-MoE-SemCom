...
def get_args():
    ...
    parser.add_argument('--train_task', default='', choices=['sen', 'trans', 'qa','mmlu','glue_mrpc','glue_qqp','labeled_final'], type=str, nargs='+', help='Training tasks')
    parser.add_argument('--test_task', default='', choices=['sen', 'trans', 'qa','mmlu','glue_mrpc','glue_qqp','labeled_final'], nargs='+', type=str, help='Evaluation Data')
