...
def get_args():
    ...
    parser.add_argument('--train_task', default='', choices=['sen', 'trans', 'qa','mmlu','glue_mrpc'], type=str, nargs='+', help='Training tasks')
    parser.add_argument('--test_task', default='', choices=['sen', 'trans', 'qa','mmlu','glue_mrpc'], nargs='+', type=str, help='Evaluation Data')
